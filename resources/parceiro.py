...
class ParceiroResource(Resource):
    ...
    def post(self):
        ...
        try:
            ...
            senha_trunc = senha_criptografada[:30]

            endereco = Endereco(cep, estado, cidade, bairro, rua, numero)

            parceiro = Parceiro(nome=nome, dt_nasc=dt_nasc, cpf=cpf, telefone=telefone, endereco=endereco, nome_fantasia=nome_fantasia, categoria=categoria, email=email, senha=senha_trunc)
